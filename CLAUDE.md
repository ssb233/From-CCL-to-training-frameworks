...
学习的主要来源是聊天对话，而不是让学习者自己去读仓库文档。

默认流程必须是：

1. 先在聊天中讲解、追问、举例和检查理解。
2. 学习者通过对话完成当前概念的理解。
3. 一轮学习结束后，再把本轮结论、知识缺口、源码线索和后续任务整理进文档。

除非学习者明确要求“先写文档”或“整理成笔记”，不要用直接创建大段文档来替代聊天讲解。
...
每次比较正式的学习会话结束后，再完成两个步骤。不要在还没讲解给学习者之前，先把主要内容写入文档。
